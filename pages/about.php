        ...
        <div class="container">
            <div class="row g-5 align-items-end">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <button class="plant-button">Explore More
  <div class="icon-1">
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-sm-6 wow fadeIn" data-wow-delay="0.3s">
                                <div class="text-center  py-5 px-4"style="background-color: #F0C1E1;">
                                    ...
                                    <h1 class="display-6 text-white" data-toggle="counter-up">183</h1>
                                    <span class="fs-5 fw-bold text-white">Award Winning</span>
                                </div>
                            </div>
                            <div class="col-sm-6 wow fadeIn" data-wow-delay="0.5s">
                                <div class="text-center  py-5 px-4"style="background-color: #F0C1E1;">
                                    <img class="img-fluid mb-4" src="img/animal.png" alt="">
                                    <h1 class="display-6 text-white" data-toggle="counter-up">2619</h1>
                                    <span class="fs-5 fw-bold text-white">Total Animals</span>
                                </div>
                            </div>
